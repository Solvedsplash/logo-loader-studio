...
export const PRESETS = [
  ...
  // ─── LIGHT & GLOW ───────────────────────────────────────────────
  p('light-shimmer', 'Shimmer', 'light', 'shimmer', 2800, 'linear', {
    intensity: 0.55, width: 0.22, angle: 20, color: '#ffffff', scaleAmp: 0, glow: 0,
  }, 'Signature'),

  p('light-chrome', 'Chrome Sweep', 'light', 'shimmer', 2200, 'linear', {
  ...
  p('light-gold', 'Gold Leaf', 'light', 'shimmer', 3400, 'linear', {
    intensity: 0.7, width: 0.1, angle: 15, color: '#fcd34d', scaleAmp: 0.01, glow: 14,
  }),

  p('light-scan', 'Scanline', 'light', 'shimmer', 2000, 'linear', {
